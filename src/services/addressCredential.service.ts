...
export const createAddressCredentialService = async (data: AddressCredential) => {
  ...
  return prisma.addressCredential.create({
    data: {
      label: data.label,
      city: data.city,
      street: data.street,
...
export const getSingleAddressCredentialService = async (userId: number | undefined, credentialId: number) => {
...
export const updateAddressCredentialService = async (
